...
void merge(vector<int> &v, int left, int mid, int right, int &inversions)
{
...
void mergeSort(vector<int> &v, int left, int right, int &inversions)
{
    if (left < right)
    {
